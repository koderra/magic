...
@Component({
  selector: 'mg-google-map',
  templateUrl: './google-map.component.html',
  styleUrls: ['./google-map.component.css'],
  providers: [
    {provide: NG_VALUE_ACCESSOR, useExisting: MgGoogleMapComponent, multi: true}
  ],
})
export class MgGoogleMapComponent extends ValueAccessorBase<string> implements OnInit {
  @Input('ngModel') value;
  @Input() placeholder = '';
  @Input() decorator;
